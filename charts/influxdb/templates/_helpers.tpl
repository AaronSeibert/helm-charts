...
Certificate name
*/}}
{{- define "influxdb.certificate.name" -}}
...
*/}}
{{- define "influxdb.certificate.secretName" -}}
{{- if not (empty .Values.certificate.secretName) }}
{{- .Values.certificate.secretName }}
{{- else }}
{{- include "influxdb.certificate.name" . }}
{{- end }}
{{- end }}
...
*/}}
{{- define "influxdb.certificate.issuerRefName" -}}
...
*/}}
{{- define "influxdb.ingressRoute.tlsSecretName" -}}
